...
- A user-requested live retry on 2026-07-28 stopped at the first request (`broken-court-monarch-boss`) with the same private Codex HTTP 429; the receipt is `resources/regeneration-attempt-20260728T130457Z.json`. It attempted 1/16, generated 0/16, and preserved `runtimeEligible: false`.
...
The latest full-packet retry is recorded in `resources/regeneration-attempt-20260728T130457Z.json`: it stopped after the first private Codex HTTP 429, with 1/16 attempted and 0/16 generated. No character texture, item texture, or background resource was promoted or written to a runtime asset path.

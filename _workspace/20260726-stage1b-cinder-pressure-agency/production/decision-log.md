...
## D-20260726-S1B-01 — Instrumentation accepted; Stage 1b gates return to redesign

```yaml
decision:
  run_id: 20260726-stage1b-cinder-pressure-agency
  date: 2026-07-26
  instrumentation_slice: ACCEPTED
  next_public_beat: DEFERRED
  gate_disposition:
    G2: FAIL
    G3: FAIL
    G5: N/A
  ...
  blocker_classification:
    G7: UNMEASURED_HUMAN_EVIDENCE
    G8: UNMEASURED_HUMAN_EVIDENCE
  observed:
    pressure:
      rows: 15
      packets: 45
      gate_minimum_band_misses: 13
      defeats: 2
      measured_boss_ttks: 13
    symmetric_explicit_wins_of_20:
      bulwark: 4
      conductor: 14
      gambit: 7
      rift: 5
      striker: 20
    formation:
      rally_to_turret_conversions: 50
      post_switch_exposed: 0
      control_companion_downs: 0
      combined_control_defeat_rate: 0.12
      legal_combo_max_ev_over_median_ev: 1.70
    persistence:
      scenarios: 3
      accepted_handoffs: 2
      writes_without_accepted_extract: 0
    human_evidence:
      g7_participants: 0
      g7_eligible_decisions: 0
      g7_voluntary_reentries: 0
      g8_survey_rows: 0
      g8_first_exposure_sessions: 0
  preserve:
    - D-20260726-S2C-01
    - D-20260726-S2C-02
    - runtime_ids
    - extraction_values_and_boundary
    - one_handoff_cap
    - campaign_schema
    - player_visible_canon
    - GLBs
    - no_monetization
    - renderer_reads_snapshot_only
  prohibited:
    - threshold_substitution
    - synthetic_evidence_as_human_evidence
    - hidden_fallbacks
    - another_data_only_retune_without_director_decision
  evidence:
    - qa/stage1b-gate-verdict-20260726.json
    - qa/stage1b-pressure-packets-20260726.json
    - qa/stage1b-g3-stance-events-20260726.json
    - qa/stage1b-persistence-scenarios-20260726.json
    - qa/stage1b-symmetric-trials-20260726.json
    - qa/g6-provenance-20260726.json
    - production/gate-reviews/stage-1b-scope.md
```

The evidence layer is now mechanically checkable and fail-closed. It did not make the current game state pass: Cinder pressure remains outside the signed band, formation switching lacks post-switch exposure, performance/release provenance misses G6, and no human G7/G8 observations exist. The packet returns to director redesign; the next public beat remains deferred.

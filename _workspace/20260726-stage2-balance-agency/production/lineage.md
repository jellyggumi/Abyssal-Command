...
- The only workspace run directory retained in the working tree is `_workspace/20260726-stage2-balance-agency/`.
- Initial concept provenance is present inside that retained run through `design/foundation-20260723-concept.md` and the immutable commit reference.

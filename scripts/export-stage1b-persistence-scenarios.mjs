...
// Repinned 2026-07-30 for the always-area combat model (defense-catalog AREA_*): area splash,
// authored attack patterns and the growth-selection event-carry fix all change the persistence
// scenarios' observable timeline, so the frozen semantic digest of the generated payload moves
// with them. Regenerated by running buildPayload("stage1b-cli-test-revision") and hashing the
// canonical bytes with sourceRevision pinned to __SOURCE_REVISION__.
const EXPECTED_PAYLOAD_SEMANTIC_SHA256 = "sha256:f2b03a87c124334ab9b972ae13430b8ad35ec254cd19fdbcfeb20f40bf7ce121";
